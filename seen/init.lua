...
local function save_data(sett, data)
	if sett ~= nil then
		...
		minetest.chat_send_all("Seen_mod: Saving data failed")
	end
end
...
minetest.register_chatcommand("seen", {
	params = "<name>",
	description = "Returns when was <name> online.",
	func = function(name, param)
		...
		if param ~= nil and param ~= "" then
			if seens[param] ~= nil then
				minetest.chat_send_player(name, param.." was last online "..relative_time(seens[param]))
			else
